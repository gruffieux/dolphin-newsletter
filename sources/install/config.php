...
$aConfig = array(
	 ...
	 * Main Section.
	 */	
	'title' => 'Newsletter', // module title, this name will be displayed in the modules list
	...
	'update_url' => 'http://www.boonex.com/market/update_ckeck?product=mg_newsl',
	 ...
	 */
	'home_dir' => 'mensgo/newsletter/', // folder where module files are located, it describes path from /modules/ folder.
	'home_uri' => 'newsletter', // module URI, so the module will be accessable via the following urls: m/bloggie/ or modules/?r=bloggie/
	
	'db_prefix' => 'mg_newsl_', // database prefix for all module tables, it is better to compose it from vendor prefix + module prefix, in out case it is me (vendor prefix) and blgg(Bloggie module prefix)
    'class_prefix' => 'MgNewsletter', // class prefix for all module classes, it is better to compose it from vendor prefix + module prefix, in out case it is Me (vendor prefix) and Blgg(Bloggie module prefix)
